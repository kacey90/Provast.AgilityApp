...
namespace Microsoft.EntityFrameworkCore
{
    public static class RDFacadeExtensions
    {
        ...
        //{
        //    CancellationToken cancellationToken = default(CancellationToken);
        //    var drx = ExecuteSqlCommandAsync(databaseFacade, sql, cancellationToken, parameters);
            
        //    using (drx.Result.DbDataReader)

        //    using (DbDataReader dr = ExecuteSqlCommandAsync(databaseFacade, sql, cancellationToken, parameters).Result.DbDataReader)
        //    {
